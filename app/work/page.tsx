    ...
    <div className="noisy min-h-dvh">
      <div className="relative flex  items-center flex-col">
        ...
        <div className="mt-32 text-center">
          ...
          <span className="border-amber-700 border px-3 mx-3 whitespace-nowrap py-1 rounded-full  shadow-black shadow-md bg-amber-900 bg-opacity-70 text-xs md:text-sm text-amber-400">
